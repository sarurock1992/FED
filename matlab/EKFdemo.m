...
for i = 2:N
    ...
    % Update aposteriori sta te estimate
...
b = stairs(2:N,z(1,2:N),'b');
hold on
% State position estimates
r = stairs(2:N,x_aposteriori(1,2:N),'r');
% State measurements
%g = plot(2:N,z(1,2:N),'g+');
title('Extended Kalman Filtering of a Sine Wave - Position');
legend([b r],'True Position','Position Estimates');
xlabel('Time')
ylabel('Position')
grid on
...
b = stairs(2:N,z(2,2:N),'b');
hold on
% State frequency estimates
r = stairs(2:N,x_aposteriori(2,2:N),'r');
